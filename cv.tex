...
\setmainfont{Newsreader.ttf}[
    UprightFont = {* Regular},  % Use the internal name for the regular style
    BoldFont    = {* Bold},     % Use the internal name for the bold style
    ItalicFont  = {* Italic}
  ]
\setCJKmainfont{NotoSerifTC-Medium.ttf}
...
\newsavebox\ANDbox
\sbox\ANDbox{$|$}
\section{Multilingual Test (多語言測試)}
Multilingual Test (多語言測試)
